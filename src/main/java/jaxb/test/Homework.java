...
public class Homework {
    ...
    public static void main(String[] args) {
        ...
        Employee emp4 = new Employee("E04", "Bob", null);
        Employee emp5 = new Employee("E05", "Jenifer", "E06");
        Employee emp6 = new Employee("E06", "Billy", null);
        ...
        Department dept2 = new Department("D02", "ENGINEERING", "BOBRUYSK");
        ...
        organisation.setName("Panasonic");
